object fmRegistedCashbill: TfmRegistedCashbill
  Left = 0
  Top = 0
  Caption = #54788#44552#50689#49688#51613#46321#47197
  ClientHeight = 691
  ClientWidth = 1179
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object btnReceipt: TcxButton
      ...
      Width = 142
      Height = 25
      Hint = #49440#53469#51088#47308' '#54788#44552#50689#49688#51613' '#48156#54665
      Caption = #54788#44552#50689#49688#51613' '#49440#53469#46321#47197
      LookAndFeel.NativeStyle = False
      LookAndFeel.SkinName = 'DevExpressStyle'
      ParentShowHint = False
      ShowHint = True
    ...
    object btnFilterDialog: TcxButton
      Left = 1126
      Top = 3
      Width = 24
      Height = 25
      Hint = #54596#53552#49373#49457#44592
      LookAndFeel.NativeStyle = False
      LookAndFeel.SkinName = 'DevExpressStyle'
      OptionsImage.Glyph.Data = {
        36040000424D3604000000000000360000002800000010000000100000000100
    ...
    object btnCancelPartial: TcxButton
      ...
      Caption = #54788#44552#50689#49688#51613' '#51204#52404#46321#47197
      LookAndFeel.NativeStyle = False
      LookAndFeel.SkinName = 'DevExpressStyle'
      ParentShowHint = False
      ShowHint = True
    ...
    object cxCheckBox1: TcxCheckBox
      Left = 487
      Top = 6
      Caption = #54788#44552#50689#49688#51613#45824#49345#51088
  ...
  object cxGrid1: TcxGrid
    ...
    object gridRequest: TcxGridDBTableView
      ...
      object gridRequestR_NO: TcxGridDBColumn
        ...
        OnGetDisplayText = gridRequestR_NOGetDisplayText
      ...
      object gridRequestS_DONG: TcxGridDBColumn
        Caption = #46041#47749
      ...
      object gridRequestOUT_WHEN: TcxGridDBColumn
      ...
      object gridRequestCASHBILL_REGISTED: TcxGridDBColumn
        Caption = #46321#47197#50668#48512
        DataBinding.FieldName = 'CASHBILL_REGISTED'
        PropertiesClassName = 'TcxImageComboBoxProperties'
        Properties.Items = <
          item
  ...
  object d_REQUEST_VIEW: TDataSource
    DataSet = registed_student_bydate
    Left = 144
    Top = 400
  end
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 43143.389876956020000000
  ...
  object registed_student_bydate: TUniQuery
    Connection = dm.UniConnection1
    SQL.Strings = (
      'select '
      ...
      '    from REGISTED_LECTURE'
        ...
        '    where (cast(REGISTED_LECTURE.p_date as date) between :s_date' +
        ' and :e_date)'
      
        '    order by REGISTED_LECTURE.p_date, lecture_active.l_idx, REGI' +
        'STED_LECTURE.ID')
    ...
    object registed_student_bydateL_YEAR: TIntegerField
      Alignment = taCenter
      FieldName = 'L_YEAR'
    end
    object registed_student_bydateL_STEP: TIntegerField
      Alignment = taCenter
      FieldName = 'L_STEP'
    end
    object registed_student_bydateL_NAME: TStringField
      Alignment = taCenter
      FieldName = 'L_NAME'
      Size = 30
    end
    object registed_student_bydateL_TIME_WEEK: TIntegerField
      FieldName = 'L_TIME_WEEK'
    end
    object registed_student_bydateL_DAYS: TStringField
      FieldName = 'L_DAYS'
      Size = 15
    end
    object registed_student_bydateL_MONTH: TIntegerField
      FieldName = 'L_MONTH'
    end
    object registed_student_bydateSTART_DATE: TStringField
      FieldName = 'START_DATE'
      FixedChar = True
      Size = 10
    end
    object registed_student_bydateEND_DATE: TStringField
      FieldName = 'END_DATE'
      FixedChar = True
      Size = 10
    end
    object registed_student_bydateCLASSROOM_ID: TStringField
      FieldName = 'CLASSROOM_ID'
      Size = 17
    end
    object registed_student_bydateIS_ACTIVE: TIntegerField
      FieldName = 'IS_ACTIVE'
    end
    object registed_student_bydateDONG_ID: TStringField
      FieldName = 'DONG_ID'
      ReadOnly = True
      Size = 17
    end
    object registed_student_bydateLECTURE_ID: TStringField
      FieldName = 'LECTURE_ID'
      ReadOnly = True
      Required = True
      Size = 17
    end
    object registed_student_bydateSTUDENT_ID: TStringField
      FieldName = 'STUDENT_ID'
      ReadOnly = True
      Required = True
      Size = 17
    end
    object registed_student_bydateP_DATE: TStringField
      Alignment = taCenter
      FieldName = 'P_DATE'
      ReadOnly = True
      Required = True
    ...
    object registed_student_bydatePAY_AMOUNT: TFloatField
      FieldName = 'PAY_AMOUNT'
      ReadOnly = True
      Required = True
      DisplayFormat = '#,0'
    end
    object registed_student_bydateIS_DC: TSmallintField
      FieldName = 'IS_DC'
      ReadOnly = True
      Required = True
    end
    object registed_student_bydatePAY_KIND: TSmallintField
      Alignment = taCenter
      FieldName = 'PAY_KIND'
      ReadOnly = True
    end
    object registed_student_bydateR_DATE: TStringField
      Alignment = taCenter
      FieldName = 'R_DATE'
      ReadOnly = True
      FixedChar = True
    ...
    object registed_student_bydateOUT_AMOUNT: TFloatField
      FieldName = 'OUT_AMOUNT'
      ReadOnly = True
      DisplayFormat = '#,0'
    end
    object registed_student_bydateREG_KIND: TSmallintField
      Alignment = taCenter
      FieldName = 'REG_KIND'
      ReadOnly = True
    end
    object registed_student_bydatePAY_WAY: TSmallintField
      Alignment = taCenter
      FieldName = 'PAY_WAY'
      ReadOnly = True
    end
    object registed_student_bydatePAYBACK_WAY: TSmallintField
      Alignment = taCenter
      FieldName = 'PAYBACK_WAY'
      ReadOnly = True
    end
    object registed_student_bydatePAYBACK_BANK: TStringField
      Alignment = taCenter
      FieldName = 'PAYBACK_BANK'
      ReadOnly = True
    end
    object registed_student_bydatePAYBACK_BANKID: TStringField
      FieldName = 'PAYBACK_BANKID'
      ReadOnly = True
      Size = 30
    end
    object registed_student_bydateOUT_KIND: TSmallintField
      Alignment = taCenter
      FieldName = 'OUT_KIND'
      ReadOnly = True
    end
    object registed_student_bydatePAYBACK_BANKOWNER: TStringField
      Alignment = taCenter
      FieldName = 'PAYBACK_BANKOWNER'
      ReadOnly = True
      Size = 30
    end
    object registed_student_bydateBIGO: TStringField
      FieldName = 'BIGO'
      ReadOnly = True
    end
    object registed_student_bydateREG_MONTH: TSmallintField
      FieldName = 'REG_MONTH'
      ReadOnly = True
    end
    object registed_student_bydateREG_MONTH2: TSmallintField
      FieldName = 'REG_MONTH2'
      ReadOnly = True
    end
    object registed_student_bydateREG_MONTH3: TSmallintField
      FieldName = 'REG_MONTH3'
      ReadOnly = True
    end
    object registed_student_bydateOUT_MONTH: TSmallintField
      FieldName = 'OUT_MONTH'
      ReadOnly = True
    end
    object registed_student_bydateOUT_MONTH2: TSmallintField
      FieldName = 'OUT_MONTH2'
      ReadOnly = True
    end
    object registed_student_bydateOUT_MONTH3: TSmallintField
      FieldName = 'OUT_MONTH3'
      ReadOnly = True
    end
    object registed_student_bydateREG_PRICE1: TFloatField
      FieldName = 'REG_PRICE1'
      ReadOnly = True
      DisplayFormat = '#,0'
    end
    object registed_student_bydateREG_PRICE2: TFloatField
      FieldName = 'REG_PRICE2'
      ReadOnly = True
      DisplayFormat = '#,0'
    end
    object registed_student_bydateREG_PRICE3: TFloatField
      FieldName = 'REG_PRICE3'
      ReadOnly = True
      DisplayFormat = '#,0'
    end
    object registed_student_bydateOUT_PRICE1: TFloatField
      FieldName = 'OUT_PRICE1'
      ReadOnly = True
      DisplayFormat = '#,0'
    end
    object registed_student_bydateOUT_PRICE2: TFloatField
      FieldName = 'OUT_PRICE2'
      ReadOnly = True
      DisplayFormat = '#,0'
    end
    object registed_student_bydateOUT_PRICE3: TFloatField
      FieldName = 'OUT_PRICE3'
      ReadOnly = True
      DisplayFormat = '#,0'
    end
    object registed_student_bydateTEACHER_ID: TStringField
      FieldName = 'TEACHER_ID'
      Size = 17
    end
    object registed_student_bydateS_NAME: TStringField
      Alignment = taCenter
      FieldName = 'S_NAME'
      ReadOnly = True
      Size = 30
    end
    object registed_student_bydateS_TEL: TStringField
      Alignment = taCenter
      FieldName = 'S_TEL'
      ReadOnly = True
      Size = 30
    end
    object registed_student_bydateS_ADDR: TStringField
      FieldName = 'S_ADDR'
      ReadOnly = True
      Size = 50
    end
    object registed_student_bydateS_KIND: TSmallintField
      Alignment = taCenter
      FieldName = 'S_KIND'
      ReadOnly = True
    end
    object registed_student_bydateS_SEX: TStringField
      Alignment = taCenter
      FieldName = 'S_SEX'
      ReadOnly = True
      Size = 4
    end
    object registed_student_bydateS_BIRTH: TStringField
      Alignment = taCenter
      FieldName = 'S_BIRTH'
      ReadOnly = True
      FixedChar = True
    ...
    object registed_student_bydateS_DONG: TStringField
      FieldName = 'S_DONG'
      ReadOnly = True
      Size = 17
    end
    object registed_student_bydateCASH_RECEIPT_NO: TStringField
      FieldName = 'CASH_RECEIPT_NO'
      ReadOnly = True
      Size = 30
    end
    object registed_student_bydateCASH_RECEIPT_YESNO: TSmallintField
      FieldName = 'CASH_RECEIPT_YESNO'
      ReadOnly = True
    end
    object registed_student_bydateID: TStringField
      FieldName = 'ID'
      ReadOnly = True
      Required = True
      Size = 17
    end
    object registed_student_bydateOUT_WHEN: TSmallintField
      Alignment = taCenter
      FieldName = 'OUT_WHEN'
      ReadOnly = True
    end
    object registed_student_bydateCASHBILL_REGISTED: TSmallintField
      Alignment = taCenter
  ...
  object UniStoredProc1: TUniStoredProc
    StoredProcName = 'REGISTED_STUDENT_BYDATE'
    Connection = dm.UniConnection1
    SpecificOptions.Strings = (
      'InterBase.FetchAll=True')
    Left = 136
    ...
    CommandStoredProcName = 'REGISTED_STUDENT_BYDATE'
  end
  object CASHBILL_INS: TUniStoredProc
    StoredProcName = 'CASHBILL_INS'
    Connection = dm.UniConnection1
    Left = 312
    Top = 464
    ParamData = <
    ...
    CommandStoredProcName = 'CASHBILL_INS'
  end
  ...
  object REGISTED_LECTURE_UPD_CASHBILL: TUniQuery
    Connection = dm.UniConnection1
    SQL.Strings = (
      'update REGISTED_LECTURE set cashbill_registed = 1'
      'where id = :id')
    Left = 312
    Top = 288
    ParamData = <
  ...
  object CASHBILL_SEL_REFID: TUniStoredProc
    StoredProcName = 'CASHBILL_SEL_REFID'
    Connection = dm.UniConnection1
    Left = 576
    Top = 216
    ParamData = <
    ...
    CommandStoredProcName = 'CASHBILL_SEL_REFID'
    object CASHBILL_SEL_REFIDID: TIntegerField
      FieldName = 'ID'
    end
  end
  object d_CASHBILL_SEL_REFID: TDataSource
    DataSet = CASHBILL_SEL_REFID
    Left = 576
    Top = 264
  end
end
