...
var
  fmExcelOpen2: TfmExcelOpen2;

implementation

{$R *.dfm}

procedure TfmExcelOpen2.BitBtn1Click(Sender: TObject);
var
  ID : string;
  xf: TXLSFile;
  I, J, cnt: Integer;
...
procedure TfmExcelOpen2.btnDelLineClick(Sender: TObject);
begin
