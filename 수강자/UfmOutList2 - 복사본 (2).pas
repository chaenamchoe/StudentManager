...
begin
  ...
  try
    ...
    if q_SELECTED_DATA_LIST.RecordCount > 0 then
      UniQuery1.Execute;
    cnt := gridOutList.DataController.FilteredRecordCount;
    gridOutList.DataController.GotoFirst;
    gridOutList.DataController.GotoNext;
    for i := 1 to cnt do begin
      rid := gridOutListID.EditValue;
      q_SELECTED_DATA_LIST.Append;
      q_SELECTED_DATA_LISTRECORD_ID.Value := rid;
      q_SELECTED_DATA_LIST.Post;
      gridOutList.DataController.GotoNext;
    end;
    gridOutList.DataController.GotoFirst;
