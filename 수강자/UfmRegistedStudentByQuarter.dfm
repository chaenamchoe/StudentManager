object fmRegistedStudentByQuarter: TfmRegistedStudentByQuarter
  Left = 0
  Top = 0
  Caption = #44053#51340'-'#48516#44592#48324' '#49688#44053#51088' '#54788#54889
  ClientHeight = 691
  ClientWidth = 1140
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object gridRequest: TcxGridDBTableView
      ...
      DataController.Summary.DefaultGroupSummaryItems = <
        item
          Format = #49688#44053'1=0'#47749
          Kind = skSum
          Column = gridRequestREG_MONTH
        end
        item
          Format = #49688#44053'2=0'#47749
          Kind = skSum
          Column = gridRequestREG_MONTH2
        end
        item
          Format = #49688#44053'3=0'#47749
          Kind = skSum
          Column = gridRequestREG_MONTH3
        end
        item
          Format = #53748#44053'1=0'#47749
          Kind = skSum
          Column = gridRequestOUT_MONTH
        end
        item
          Format = #53748#44053'2=0'#47749
          Kind = skSum
          Column = gridRequestOUT_MONTH2
        end
        item
          Format = #53748#44053'3=0'#47749
          Kind = skSum
      ...
      Styles.Group = cxStyleRed
      Styles.GroupSummary = cxStyleBlue
      OnCustomDrawGroupSummaryCell = gridRequestCustomDrawGroupSummaryCell
      ...
      object gridRequestL_IDX: TcxGridDBColumn
        Caption = #44053#51340#48324' '#49548#44228
        DataBinding.FieldName = 'L_IDX'
        Visible = False
        OnCustomDrawCell = gridRequestL_IDXCustomDrawCell
        GroupIndex = 0
        Width = 49
      end
  ...
  object d_REQUEST_VIEW: TDataSource
    DataSet = REGISTED_STUDENT_BYQUARTER
    Left = 144
    Top = 400
  end
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TdxGridReportLink
      ...
      ReportFootnotes.Font.Name = #44404#47548
      ReportFootnotes.Font.Style = [fsBold]
      ReportFootnotes.Mode = fnmOnLastPage
      ReportFootnotes.TextAlignX = taLeft
      ReportFootnotes.TextAlignY = taTop
  ...
  object REGISTED_STUDENT_BYQUARTER: TUniStoredProc
    StoredProcName = 'REGISTED_STUDENT_BYQUARTER'
    Connection = dm.UniConnection1
    Left = 144
    Top = 352
    ParamData = <
    ...
    CommandStoredProcName = 'REGISTED_STUDENT_BYQUARTER'
    object REGISTED_STUDENT_BYQUARTERR_NO: TIntegerField
      Alignment = taCenter
      FieldName = 'R_NO'
    end
    object REGISTED_STUDENT_BYQUARTERL_YEAR: TIntegerField
      Alignment = taCenter
      FieldName = 'L_YEAR'
    end
    object REGISTED_STUDENT_BYQUARTERL_STEP: TIntegerField
      Alignment = taCenter
      FieldName = 'L_STEP'
    end
    object REGISTED_STUDENT_BYQUARTERL_NAME: TStringField
      FieldName = 'L_NAME'
      Size = 30
    end
    object REGISTED_STUDENT_BYQUARTERL_TIME_WEEK: TIntegerField
      FieldName = 'L_TIME_WEEK'
    end
    object REGISTED_STUDENT_BYQUARTERL_DAYS: TStringField
      FieldName = 'L_DAYS'
      Size = 15
    end
    object REGISTED_STUDENT_BYQUARTERL_MONTH: TIntegerField
      FieldName = 'L_MONTH'
    end
    object REGISTED_STUDENT_BYQUARTERSTART_DATE: TStringField
      FieldName = 'START_DATE'
      FixedChar = True
      Size = 10
    end
    object REGISTED_STUDENT_BYQUARTEREND_DATE: TStringField
      FieldName = 'END_DATE'
      FixedChar = True
      Size = 10
    end
    object REGISTED_STUDENT_BYQUARTERCLASSROOM_ID: TStringField
      FieldName = 'CLASSROOM_ID'
      Size = 17
    end
    object REGISTED_STUDENT_BYQUARTERIS_ACTIVE: TIntegerField
      FieldName = 'IS_ACTIVE'
    end
    object REGISTED_STUDENT_BYQUARTERDONG_ID: TStringField
      FieldName = 'DONG_ID'
      Size = 17
    end
    object REGISTED_STUDENT_BYQUARTERLECTURE_ID: TStringField
      FieldName = 'LECTURE_ID'
      Size = 17
    end
    object REGISTED_STUDENT_BYQUARTERSTUDENT_ID: TStringField
      FieldName = 'STUDENT_ID'
      Size = 17
    end
    object REGISTED_STUDENT_BYQUARTERP_DATE: TStringField
      Alignment = taCenter
      FieldName = 'P_DATE'
      FixedChar = True
      Size = 10
    end
    object REGISTED_STUDENT_BYQUARTERPAY_AMOUNT: TFloatField
      FieldName = 'PAY_AMOUNT'
      DisplayFormat = '#,'
    end
    object REGISTED_STUDENT_BYQUARTERIS_DC: TSmallintField
      FieldName = 'IS_DC'
    end
    object REGISTED_STUDENT_BYQUARTERPAY_KIND: TSmallintField
      Alignment = taCenter
      FieldName = 'PAY_KIND'
    end
    object REGISTED_STUDENT_BYQUARTERR_DATE: TStringField
      Alignment = taCenter
      FieldName = 'R_DATE'
      FixedChar = True
      Size = 10
    end
    object REGISTED_STUDENT_BYQUARTEROUT_AMOUNT: TFloatField
      FieldName = 'OUT_AMOUNT'
      DisplayFormat = '#,'
    end
    object REGISTED_STUDENT_BYQUARTERREG_KIND: TSmallintField
      Alignment = taCenter
      FieldName = 'REG_KIND'
    end
    object REGISTED_STUDENT_BYQUARTERPAY_WAY: TSmallintField
      Alignment = taCenter
      FieldName = 'PAY_WAY'
    end
    object REGISTED_STUDENT_BYQUARTERPAYBACK_WAY: TSmallintField
      FieldName = 'PAYBACK_WAY'
    end
    object REGISTED_STUDENT_BYQUARTERPAYBACK_BANK: TStringField
      FieldName = 'PAYBACK_BANK'
    end
    object REGISTED_STUDENT_BYQUARTERPAYBACK_BANKID: TStringField
      FieldName = 'PAYBACK_BANKID'
      Size = 30
    end
    object REGISTED_STUDENT_BYQUARTEROUT_KIND: TSmallintField
      Alignment = taCenter
      FieldName = 'OUT_KIND'
    end
    object REGISTED_STUDENT_BYQUARTERPAYBACK_BANKOWNER: TStringField
      FieldName = 'PAYBACK_BANKOWNER'
      Size = 30
    end
    object REGISTED_STUDENT_BYQUARTERBIGO: TStringField
      FieldName = 'BIGO'
    end
    object REGISTED_STUDENT_BYQUARTERREG_MONTH: TSmallintField
      Alignment = taCenter
      FieldName = 'REG_MONTH'
    end
    object REGISTED_STUDENT_BYQUARTEROUT_MONTH: TSmallintField
      Alignment = taCenter
      FieldName = 'OUT_MONTH'
    end
    object REGISTED_STUDENT_BYQUARTERTEACHER_ID: TStringField
      FieldName = 'TEACHER_ID'
      Size = 17
    end
    object REGISTED_STUDENT_BYQUARTERS_NAME: TStringField
      FieldName = 'S_NAME'
      Size = 30
    end
    object REGISTED_STUDENT_BYQUARTERS_TEL: TStringField
      FieldName = 'S_TEL'
      Size = 30
    end
    object REGISTED_STUDENT_BYQUARTERS_ADDR: TStringField
      FieldName = 'S_ADDR'
      Size = 50
    end
    object REGISTED_STUDENT_BYQUARTERS_KIND: TSmallintField
      Alignment = taCenter
      FieldName = 'S_KIND'
    end
    object REGISTED_STUDENT_BYQUARTERS_SEX: TStringField
      Alignment = taCenter
      FieldName = 'S_SEX'
      Size = 4
    end
    object REGISTED_STUDENT_BYQUARTERS_BIRTH: TStringField
      FieldName = 'S_BIRTH'
      FixedChar = True
      Size = 10
    end
    object REGISTED_STUDENT_BYQUARTERS_DONG: TStringField
      FieldName = 'S_DONG'
      Size = 17
    end
    object REGISTED_STUDENT_BYQUARTERCASH_RECEIPT_NO: TStringField
      FieldName = 'CASH_RECEIPT_NO'
      Size = 30
    end
    object REGISTED_STUDENT_BYQUARTERCASH_RECEIPT_YESNO: TSmallintField
      FieldName = 'CASH_RECEIPT_YESNO'
    end
    object REGISTED_STUDENT_BYQUARTERT_NAME: TStringField
      FieldName = 'T_NAME'
    end
    object REGISTED_STUDENT_BYQUARTERT_SEX: TStringField
      FieldName = 'T_SEX'
      Size = 4
    end
    object REGISTED_STUDENT_BYQUARTERT_TEL: TStringField
      FieldName = 'T_TEL'
      Size = 30
    end
    object REGISTED_STUDENT_BYQUARTERBANK_NAME: TStringField
      FieldName = 'BANK_NAME'
    end
    object REGISTED_STUDENT_BYQUARTERBANK_NO: TStringField
      FieldName = 'BANK_NO'
      Size = 30
    end
    object REGISTED_STUDENT_BYQUARTERID: TStringField
      FieldName = 'ID'
      Size = 17
    end
    object REGISTED_STUDENT_BYQUARTERREG_MONTH2: TSmallintField
      FieldName = 'REG_MONTH2'
    end
    object REGISTED_STUDENT_BYQUARTERREG_MONTH3: TSmallintField
      FieldName = 'REG_MONTH3'
    end
    object REGISTED_STUDENT_BYQUARTEROUT_MONTH2: TSmallintField
      FieldName = 'OUT_MONTH2'
    end
    object REGISTED_STUDENT_BYQUARTEROUT_MONTH3: TSmallintField
      FieldName = 'OUT_MONTH3'
    end
    object REGISTED_STUDENT_BYQUARTERL_IDX: TSmallintField
      FieldName = 'L_IDX'
    end
    object REGISTED_STUDENT_BYQUARTERREG_PRICE1: TFloatField
      FieldName = 'REG_PRICE1'
      DisplayFormat = '#,0'
    end
    object REGISTED_STUDENT_BYQUARTERREG_PRICE2: TFloatField
      FieldName = 'REG_PRICE2'
      DisplayFormat = '#,0'
    end
    object REGISTED_STUDENT_BYQUARTERREG_PRICE3: TFloatField
      FieldName = 'REG_PRICE3'
      DisplayFormat = '#,0'
    end
    object REGISTED_STUDENT_BYQUARTEROUT_PRICE1: TFloatField
      FieldName = 'OUT_PRICE1'
      DisplayFormat = '#,0'
    end
    object REGISTED_STUDENT_BYQUARTEROUT_PRICE2: TFloatField
      FieldName = 'OUT_PRICE2'
      DisplayFormat = '#,0'
    end
    object REGISTED_STUDENT_BYQUARTEROUT_PRICE3: TFloatField
