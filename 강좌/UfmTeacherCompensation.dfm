object fmTeacherCompensation: TfmTeacherCompensation
  ...
  object Panel1: TPanel
    ...
    object chkSudangFilter: TCheckBox
      Left = 273
      Top = 7
      Width = 105
      Height = 17
      Caption = #44552#50529' 0 '#44048#52628#44592
      TabOrder = 2
      OnClick = chkSudangFilterClick
    end
  ...
  object cxGrid1: TcxGrid
    ...
    object gridCompensation: TcxGridDBTableView
      ...
      DataController.DataSource = d_SP_GET_COMPANSATION
      DataController.Options = [dcoAssignGroupingValues, dcoAssignMasterDetailKeys, dcoSaveExpanding, dcoGroupsAlwaysExpanded]
      DataController.Summary.DefaultGroupSummaryItems = <
        item
          Format = '#,'
          Kind = skSum
          Column = gridCompensationCOMMON_COUNT
        end
        item
          Format = '#,'
          Kind = skSum
          Column = gridCompensationDC_TOTAL
        end
        item
          Format = '#,'
          Kind = skSum
          Column = gridCompensationDC_COUNT1
        end
        item
          Format = '#,'
          Kind = skSum
          Column = gridCompensationDC_COUNT2
        end
        item
          Format = '#,'
          Kind = skSum
          Column = gridCompensationDC_COUNT3
        end
        item
          Format = '#,'
          Kind = skSum
          Column = gridCompensationDC_COUNT4
        end
        item
          Format = '#,'
          Kind = skSum
          Column = gridCompensationDC_COUNT5
        end
        item
          Format = '#,'
          Kind = skSum
          Column = gridCompensationDC_COUNT6
        end
        item
          Format = '#,'
          Kind = skSum
          Column = gridCompensationdc_price
        end
        item
          Format = '#,'
          Kind = skSum
        ...
        item
          ...
          Kind = skCount
          Column = gridCompensationL_NAME
        end
        item
          Format = '#,'
          Kind = skSum
          Column = gridCompensationcount_total
        end>
      ...
      object gridCompensationp_month: TcxGridDBColumn
        Caption = #50900
      ...
      object gridCompensationColumn1: TcxGridDBColumn
        Caption = 'No'
      ...
      object gridCompensationID: TcxGridDBColumn
        DataBinding.FieldName = 'ID'
        Visible = False
        Width = 52
      end
      object gridCompensationL_NAME: TcxGridDBColumn
      ...
      object gridCompensationTEACHER_ID: TcxGridDBColumn
        Caption = #44053#49324#47749
      ...
      object gridCompensationTEACHER_PERCENT: TcxGridDBColumn
        Caption = #49688#45817#50836#50984
        DataBinding.FieldName = 'TEACHER_PERCENT'
        Visible = False
        HeaderAlignmentHorz = taCenter
      end
      object gridCompensationcount_total: TcxGridDBColumn
        DataBinding.FieldName = 'count_total'
        HeaderAlignmentHorz = taCenter
      end
      object gridCompensationCOMMON_COUNT: TcxGridDBColumn
        Caption = #51068#48152
        DataBinding.FieldName = 'COMMON_COUNT'
        HeaderAlignmentHorz = taCenter
        Width = 53
      end
      object gridCompensationDC_TOTAL: TcxGridDBColumn
        Caption = #44048#47732#51088
        DataBinding.FieldName = 'DC_TOTAL'
        OnCustomDrawCell = gridCompensationDC_TOTALCustomDrawCell
        HeaderAlignmentHorz = taCenter
        Width = 58
      end
      object gridCompensationDC_COUNT1: TcxGridDBColumn
        Caption = #49688#44553#51088
        DataBinding.FieldName = 'DC_COUNT1'
        HeaderAlignmentHorz = taCenter
        Width = 54
      end
      object gridCompensationDC_COUNT2: TcxGridDBColumn
        Caption = #50976#44277#51088
        DataBinding.FieldName = 'DC_COUNT2'
        HeaderAlignmentHorz = taCenter
        Width = 52
      end
      object gridCompensationDC_COUNT3: TcxGridDBColumn
        Caption = #45432#51064
        DataBinding.FieldName = 'DC_COUNT3'
        HeaderAlignmentHorz = taCenter
        Width = 46
      end
      object gridCompensationDC_COUNT4: TcxGridDBColumn
        Caption = #51109#50528#51064
        DataBinding.FieldName = 'DC_COUNT4'
        HeaderAlignmentHorz = taCenter
        Width = 51
      end
      object gridCompensationDC_COUNT5: TcxGridDBColumn
        Caption = #45796#51088#45376
        DataBinding.FieldName = 'DC_COUNT5'
        HeaderAlignmentHorz = taCenter
        Width = 48
      end
      object gridCompensationDC_COUNT6: TcxGridDBColumn
        Caption = #51032#49324#51088
        DataBinding.FieldName = 'DC_COUNT6'
        HeaderAlignmentHorz = taCenter
        Width = 52
      end
      object gridCompensationL_PRICE: TcxGridDBColumn
        Caption = #49688#44053#47308
        DataBinding.FieldName = 'L_PRICE'
        HeaderAlignmentHorz = taRightJustify
        Width = 69
      end
      object gridCompensationSUDANG: TcxGridDBColumn
        Caption = #49688#45817
        DataBinding.FieldName = 'SUDANG'
        Visible = False
        VisibleForCustomization = False
      end
      object gridCompensationLEC_PRICE: TcxGridDBColumn
        Caption = #44048#47732#48372#51204
        DataBinding.FieldName = 'LEC_PRICE'
        HeaderAlignmentHorz = taRightJustify
        Width = 66
      end
      object gridCompensationdc_price: TcxGridDBColumn
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 43144.241242581020000000
