...
uses
  ...
  IdTCPConnection, IdTCPClient, IdHTTP, Gauges, cxGridBandedTableView,
...
type
  TfmLectureView = class(TForm)
    ...
    gridLecture: TcxGridDBBandedTableView;
    gridLectureID: TcxGridDBBandedColumn;
    gridLectureDONG_ID: TcxGridDBBandedColumn;
    gridLectureL_YEAR: TcxGridDBBandedColumn;
    gridLectureL_STEP: TcxGridDBBandedColumn;
    gridLectureL_NAME: TcxGridDBBandedColumn;
    gridLectureL_TIME_WEEK: TcxGridDBBandedColumn;
    gridLectureL_DAYS: TcxGridDBBandedColumn;
    gridLectureL_MONTH: TcxGridDBBandedColumn;
    gridLectureSTART_DATE: TcxGridDBBandedColumn;
    gridLectureTEACHER_ID: TcxGridDBBandedColumn;
    gridLectureTEACHER_ID2: TcxGridDBBandedColumn;
    gridLectureTEACHER_ID3: TcxGridDBBandedColumn;
    gridLectureL_PRICE: TcxGridDBBandedColumn;
    gridLectureCLASSROOM_ID: TcxGridDBBandedColumn;
    gridLectureIS_ACTIVE: TcxGridDBBandedColumn;
    gridLectureL_DURATION: TcxGridDBBandedColumn;
    gridLectureL_TIME: TcxGridDBBandedColumn;
    gridLectureL_TIME_START: TcxGridDBBandedColumn;
    gridLectureL_TIME_END: TcxGridDBBandedColumn;
    gridLectureEND_DATE: TcxGridDBBandedColumn;
    gridLecturePLAN_MEN: TcxGridDBBandedColumn;
    gridLectureREGIST_MEN: TcxGridDBBandedColumn;
    gridLectureWAIT_MEN: TcxGridDBBandedColumn;
    gridLectureDROP_MEN: TcxGridDBBandedColumn;
    gridLectureTOTAL_DAY: TcxGridDBBandedColumn;
    gridLectureTOTAL_TIME: TcxGridDBBandedColumn;
    gridLectureTEACHER_PERCENT: TcxGridDBBandedColumn;
    gridLectureCALC_KIND: TcxGridDBBandedColumn;
    gridLectureMONTH1_DAYS: TcxGridDBBandedColumn;
    gridLectureMONTH2_DAYS: TcxGridDBBandedColumn;
    gridLectureMONTH3_DAYS: TcxGridDBBandedColumn;
    gridLectureL_IDX: TcxGridDBBandedColumn;
    gridLectureL_UID: TcxGridDBBandedColumn;
    gridLectureMONTH1_PRICE: TcxGridDBBandedColumn;
    gridLectureMONTH2_PRICE: TcxGridDBBandedColumn;
    gridLectureMONTH3_PRICE: TcxGridDBBandedColumn;
    gridLecturePARENT_LECTURE_ID: TcxGridDBBandedColumn;
