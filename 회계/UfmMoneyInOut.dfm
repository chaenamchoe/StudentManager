object fmMoneyInOut: TfmMoneyInOut
  Left = 0
  Top = 0
  ...
  object Panel1: TPanel
    ...
    object btnMoneyReturn: TBitBtn
      Left = 798
      Top = 2
      Width = 66
      Height = 25
      Caption = #48152#54872#44208#51032
      TabOrder = 9
      OnClick = btnMoneyReturnClick
    end
  ...
  object cxGrid1: TcxGrid
    ...
    object gridMoneyInout: TcxGridDBTableView
      ...
      DataController.DataSource = d_MONEY_INOUT_WONJANG_DAY
  ...
  object MONEY_INOUT_WONJANG_DAY: TUniStoredProc
    StoredProcName = 'MONEY_INOUT_WONJANG_DAY'
    ...
    CommandStoredProcName = 'MONEY_INOUT_WONJANG_DAY'
    object MONEY_INOUT_WONJANG_DAYID: TIntegerField
      FieldName = 'ID'
    end
    object MONEY_INOUT_WONJANG_DAYIO_DATE: TDateField
      FieldName = 'IO_DATE'
    end
    object MONEY_INOUT_WONJANG_DAYIO_ITEM_ID: TIntegerField
      FieldName = 'IO_ITEM_ID'
    end
    object MONEY_INOUT_WONJANG_DAYIO_SUBITEM_ID: TIntegerField
      FieldName = 'IO_SUBITEM_ID'
    end
    object MONEY_INOUT_WONJANG_DAYIO_DETAIL_ID: TIntegerField
      FieldName = 'IO_DETAIL_ID'
    end
    object MONEY_INOUT_WONJANG_DAYIO_JUKYO: TStringField
      FieldName = 'IO_JUKYO'
      Size = 50
    end
    object MONEY_INOUT_WONJANG_DAYIO_IN: TFloatField
      FieldName = 'IO_IN'
      DisplayFormat = '#,0'
    end
    object MONEY_INOUT_WONJANG_DAYIO_OUT: TFloatField
      FieldName = 'IO_OUT'
      DisplayFormat = '#,0'
    end
    object MONEY_INOUT_WONJANG_DAYIO_REST: TFloatField
      FieldName = 'IO_REST'
      DisplayFormat = '#,0'
    end
    object MONEY_INOUT_WONJANG_DAYIO_DONG_ID: TStringField
      FieldName = 'IO_DONG_ID'
      Size = 17
    end
    object MONEY_INOUT_WONJANG_DAYIO_KIND: TSmallintField
      FieldName = 'IO_KIND'
    end
    object MONEY_INOUT_WONJANG_DAYDATA_KIND: TIntegerField
      FieldName = 'DATA_KIND'
    end
    object MONEY_INOUT_WONJANG_DAYIO_REG_LECTURE_ID: TStringField
      FieldName = 'IO_REG_LECTURE_ID'
      Size = 17
    end
  end
  object d_MONEY_INOUT_WONJANG_DAY: TDataSource
    DataSet = MONEY_INOUT_WONJANG_DAY
    Left = 224
    Top = 360
  end
  ...
  object MONEY_INOUT_MOVE: TUniStoredProc
    StoredProcName = 'MONEY_INOUT_MOVE'
    Connection = dm.UniConnection1
    Left = 424
    Top = 312
    ParamData = <
    ...
    CommandStoredProcName = 'MONEY_INOUT_MOVE'
  end
end
