...
type
  ...
  ['{0AF0A6EB-76C3-BA96-0C56-69DDB1FE2B13}']
    ...
    function  CancelCashBillPartial(const CERTKEY: WideString; const CorpNum: WideString; const UserID: WideString; const MgtKey: WideString; const CancelType: WideString; const CancelAmount: WideString; const CancelTax: WideString; const CancelServiceCharge: WideString; const SMSSendYN: Boolean; const MailTitle: WideString): Integer; stdcall;
