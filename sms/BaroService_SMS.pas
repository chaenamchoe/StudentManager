...
// WSDL     : http://testws.baroservice.com/sms.asmx?wsdl
// Encoding : utf-8
// Version  : 1.0
// (2015-10-22 ¿ÀÈÄ 2:05:27 - 1.33.2.5)
// ************************************************************************ //

unit BaroService_SMS;
...
type
  ...
  // URL       : http://testws.baroservice.com/sms.asmx
  // ************************************************************************ //
  ...
  ['{58F9AB04-D915-122E-384A-3562F386E285}']
    ...
    function  SendLMSMessage(const CERTKEY: WideString; const CorpNum: WideString; const SenderID: WideString; const FromNumber: WideString; const ToName: WideString; const ToNumber: WideString; const Subject: WideString; const Contents: WideString; const SendDT: WideString; const RefKey: WideString
                             ): WideString; stdcall;
    ...
    function  SendMMSMessageFromFTP(const CERTKEY: WideString; const CorpNum: WideString; const SenderID: WideString; const FromNumber: WideString; const ToName: WideString; const ToNumber: WideString; const TXTSubject: WideString; const TXTMESSAGE: WideString; const ImageFileName: WideString; const SendDT: WideString; 
                                    const RefKey: WideString): WideString; stdcall;
    ...
    function  CancelReservedSMSMessageByReceiptNum(const CERTKEY: WideString; const CorpNum: WideString; const ReceiptNum: WideString): Integer; stdcall;
    ...
    function  GetBaroBillURL(const CERTKEY: WideString; const CorpNum: WideString; const ID: WideString; const PWD: WideString; const TOGO: WideString): WideString; stdcall;
